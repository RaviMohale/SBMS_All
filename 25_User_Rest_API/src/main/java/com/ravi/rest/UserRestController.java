...
public class UserRestController {
	...
	@GetMapping("/user")
	public User getUserId(@RequestParam("userid")Integer userId) {
	...
	@GetMapping("/user1")
	public User getUser(@RequestParam("userid")Integer userId,@RequestParam("username")String name) {
		
		User user = dataMap.get(userId);
		//User user1 = dataMap.get(name);
		//User user = dataMap.get();
